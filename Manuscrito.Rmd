...
% \includepdf[pages=-]{Portada.pdf}  % cover page omitted from the public repo
...
h <- readRDS("COMPANIES/RESULTADOS_v4/helper_tablas_v4.rds")
...
h_news <- readRDS("COMPANIES/RESULTADOS_NEWS_v1.0/helper_tablas_news_v1.rds")
