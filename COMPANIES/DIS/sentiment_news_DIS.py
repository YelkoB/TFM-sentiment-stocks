"""
sentiment_news_DIS.py - Financial-news sentiment for Disney (DIS)
...
Input:  news_DIS.csv  (columns: Date, Article_title, Lsa_summary, Stock_symbol)
Output: news_dis_sentiments_S1_title_only.csv
        news_dis_sentiments_S2_smart_weighted.csv
...
INPUT_FILE = os.path.join(SCRIPT_DIR, "news_DIS.csv")
OUTPUT_FILE_BASE = os.path.join(SCRIPT_DIR, "news_dis_sentiments")
BATCH_SIZE = 32
...
print("=" * 70)
print("SENTIMENT ANALYSIS - NEWS DIS (2 STRATEGIES)")
print("=" * 70)
print(f"\nInput:  {INPUT_FILE}")
