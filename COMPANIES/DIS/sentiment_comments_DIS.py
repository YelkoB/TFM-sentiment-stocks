"""
sentiment_comments_DIS.py - Reddit comment sentiment for Disney (DIS)
...
Input:  comments_dis_clean.csv
Output: comments_dis_all_sentiments.csv
...
INPUT_FILE = os.path.join(SCRIPT_DIR, "comments_dis_clean.csv")
OUTPUT_FILE = os.path.join(SCRIPT_DIR, "comments_dis_all_sentiments.csv")
BATCH_SIZE = 32

print("=" * 70)
print("SENTIMENT ANALYSIS - REDDIT COMMENTS DIS")
print("=" * 70)
print(f"\nInput:  {INPUT_FILE}")
