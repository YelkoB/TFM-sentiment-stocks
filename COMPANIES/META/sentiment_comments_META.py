"""
sentiment_comments_META.py - Reddit comment sentiment for Meta (META)
...
Input:  comments_meta_clean.csv
Output: comments_meta_all_sentiments.csv
...
INPUT_FILE = os.path.join(SCRIPT_DIR, "comments_meta_clean.csv")
OUTPUT_FILE = os.path.join(SCRIPT_DIR, "comments_meta_all_sentiments.csv")
BATCH_SIZE = 32

print("=" * 70)
print("SENTIMENT ANALYSIS - REDDIT COMMENTS META")
print("=" * 70)
print(f"\nInput:  {INPUT_FILE}")
