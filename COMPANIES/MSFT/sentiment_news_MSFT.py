"""
sentiment_news_MSFT.py - Financial-news sentiment for Microsoft (MSFT)
...
Input:  news_MSFT.csv  (columns: Date, Article_title, Lsa_summary, Stock_symbol)
Output: news_msft_sentiments_S1_title_only.csv
        news_msft_sentiments_S2_smart_weighted.csv
...
INPUT_FILE = os.path.join(SCRIPT_DIR, "news_MSFT.csv")
OUTPUT_FILE_BASE = os.path.join(SCRIPT_DIR, "news_msft_sentiments")
BATCH_SIZE = 32
...
TERMS = [
    ...
    'windows', 'windows 11',
    'azure', 'azure cloud',
    'office', 'microsoft 365', 'office 365',
...
print("=" * 70)
print("SENTIMENT ANALYSIS - NEWS MSFT (2 STRATEGIES)")
print("=" * 70)
print(f"\nInput:  {INPUT_FILE}")
