"""
sentiment_news_AMZN.py - Financial-news sentiment for Amazon (AMZN)
...
Input:  news_AMZN.csv  (columns: Date, Article_title, Lsa_summary, Stock_symbol)
Output: news_amzn_sentiments_S1_title_only.csv
        news_amzn_sentiments_S2_smart_weighted.csv
...
INPUT_FILE = os.path.join(SCRIPT_DIR, "news_AMZN.csv")
OUTPUT_FILE_BASE = os.path.join(SCRIPT_DIR, "news_amzn_sentiments")
BATCH_SIZE = 32
...
print("=" * 70)
print("SENTIMENT ANALYSIS - NEWS AMZN (2 STRATEGIES)")
print("=" * 70)
print(f"\nInput:  {INPUT_FILE}")
