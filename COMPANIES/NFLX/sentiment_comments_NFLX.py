"""
sentiment_comments_NFLX.py - Reddit comment sentiment for Netflix (NFLX)
...
Input:  comments_nflx_clean.csv
Output: comments_nflx_all_sentiments.csv
...
INPUT_FILE = os.path.join(SCRIPT_DIR, "comments_nflx_clean.csv")
OUTPUT_FILE = os.path.join(SCRIPT_DIR, "comments_nflx_all_sentiments.csv")
BATCH_SIZE = 32

print("=" * 70)
print("SENTIMENT ANALYSIS - REDDIT COMMENTS NFLX")
print("=" * 70)
print(f"\nInput:  {INPUT_FILE}")
