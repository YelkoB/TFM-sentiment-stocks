"""
sentiment_news_AAPL.py - Financial-news sentiment for Apple (AAPL)
...
Input:  news_AAPL.csv  (columns: Date, Article_title, Lsa_summary, Stock_symbol)
Output: news_aapl_sentiments_S1_title_only.csv
        news_aapl_sentiments_S2_smart_weighted.csv
...
INPUT_FILE = os.path.join(SCRIPT_DIR, "news_AAPL.csv")
OUTPUT_FILE_BASE = os.path.join(SCRIPT_DIR, "news_aapl_sentiments")
BATCH_SIZE = 32
...
TERMS = [
    'aapl', 'apple',
    'iphone', 'ipad', 'macbook', 'mac', 'imac', 'mac pro', 'mac mini',
    'ios', 'macos', 'ipados', 'watchos', 'tvos',
    'tim cook', 'cook',
    'airpods', 'apple watch', 'vision pro', 'apple tv',
...
print("=" * 70)
print("SENTIMENT ANALYSIS - NEWS AAPL (2 STRATEGIES)")
print("=" * 70)
print(f"\nInput:  {INPUT_FILE}")
