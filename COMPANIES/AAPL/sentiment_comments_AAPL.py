"""
sentiment_comments_AAPL.py - Reddit comment sentiment for Apple (AAPL)
...
Input:  comments_aapl_clean.csv
Output: comments_aapl_all_sentiments.csv
...
INPUT_FILE = os.path.join(SCRIPT_DIR, "comments_aapl_clean.csv")
OUTPUT_FILE = os.path.join(SCRIPT_DIR, "comments_aapl_all_sentiments.csv")
BATCH_SIZE = 32

print("=" * 70)
print("SENTIMENT ANALYSIS - REDDIT COMMENTS AAPL")
print("=" * 70)
print(f"\nInput:  {INPUT_FILE}")
