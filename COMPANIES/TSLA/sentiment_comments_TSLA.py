"""
sentiment_comments_TSLA.py - Reddit comment sentiment for Tesla (TSLA)
...
Input:  comments_tsla_clean.csv
Output: comments_tsla_all_sentiments.csv
...
INPUT_FILE = os.path.join(SCRIPT_DIR, "comments_tsla_clean.csv")
OUTPUT_FILE = os.path.join(SCRIPT_DIR, "comments_tsla_all_sentiments.csv")
BATCH_SIZE = 32

print("=" * 70)
print("SENTIMENT ANALYSIS - REDDIT COMMENTS TSLA")
print("=" * 70)
print(f"\nInput:  {INPUT_FILE}")
