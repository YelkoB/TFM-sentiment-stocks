"""
sentiment_news_TSLA.py - Financial-news sentiment for Tesla (TSLA)
...
Input:  news_TSLA.csv  (columns: Date, Article_title, Lsa_summary, Stock_symbol)
Output: news_tsla_sentiments_S1_title_only.csv
        news_tsla_sentiments_S2_smart_weighted.csv
...
INPUT_FILE = os.path.join(SCRIPT_DIR, "news_TSLA.csv")
OUTPUT_FILE_BASE = os.path.join(SCRIPT_DIR, "news_tsla_sentiments")
BATCH_SIZE = 32
...
print("=" * 70)
print("SENTIMENT ANALYSIS - NEWS TSLA (2 STRATEGIES)")
print("=" * 70)
print(f"\nInput:  {INPUT_FILE}")
