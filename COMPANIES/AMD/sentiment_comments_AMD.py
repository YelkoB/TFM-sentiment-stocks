"""
sentiment_comments_AMD.py - Reddit comment sentiment for AMD (AMD)
...
Input:  comments_amd_clean.csv
Output: comments_amd_all_sentiments.csv
...
INPUT_FILE = os.path.join(SCRIPT_DIR, "comments_amd_clean.csv")
OUTPUT_FILE = os.path.join(SCRIPT_DIR, "comments_amd_all_sentiments.csv")
BATCH_SIZE = 32

print("=" * 70)
print("SENTIMENT ANALYSIS - REDDIT COMMENTS AMD")
print("=" * 70)
print(f"\nInput:  {INPUT_FILE}")
