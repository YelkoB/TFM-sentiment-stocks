"""
sentiment_comments_NVDA.py - Reddit comment sentiment for Nvidia (NVDA)
...
Input:  comments_nvda_clean.csv
Output: comments_nvda_all_sentiments.csv
...
INPUT_FILE = os.path.join(SCRIPT_DIR, "comments_nvda_clean.csv")
OUTPUT_FILE = os.path.join(SCRIPT_DIR, "comments_nvda_all_sentiments.csv")
BATCH_SIZE = 32

print("=" * 70)
print("SENTIMENT ANALYSIS - REDDIT COMMENTS NVDA")
print("=" * 70)
print(f"\nInput:  {INPUT_FILE}")
