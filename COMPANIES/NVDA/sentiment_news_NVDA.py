"""
sentiment_news_NVDA.py - Financial-news sentiment for Nvidia (NVDA)
...
Input:  news_NVDA.csv  (columns: Date, Article_title, Lsa_summary, Stock_symbol)
Output: news_nvda_sentiments_S1_title_only.csv
        news_nvda_sentiments_S2_smart_weighted.csv
...
INPUT_FILE = os.path.join(SCRIPT_DIR, "news_NVDA.csv")
OUTPUT_FILE_BASE = os.path.join(SCRIPT_DIR, "news_nvda_sentiments")
BATCH_SIZE = 32
...
TERMS = [
    ...
    'gpu', 'graphics card',
    'geforce', 'quadro',
    'h100', 'h200', 'a100', 'b100', 'b200', 'gb200',
...
print("=" * 70)
print("SENTIMENT ANALYSIS - NEWS NVDA (2 STRATEGIES)")
print("=" * 70)
print(f"\nInput:  {INPUT_FILE}")
