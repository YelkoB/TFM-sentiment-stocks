"""
sentiment_comments_GOOGL.py - Reddit comment sentiment for Alphabet (GOOGL)
...
Input:  comments_googl_clean.csv
Output: comments_googl_all_sentiments.csv
...
INPUT_FILE = os.path.join(SCRIPT_DIR, "comments_googl_clean.csv")
OUTPUT_FILE = os.path.join(SCRIPT_DIR, "comments_googl_all_sentiments.csv")
BATCH_SIZE = 32

print("=" * 70)
print("SENTIMENT ANALYSIS - REDDIT COMMENTS GOOGL")
print("=" * 70)
print(f"\nInput:  {INPUT_FILE}")
