"""
sentiment_news_GOOGL.py - Financial-news sentiment for Alphabet (GOOGL)
...
Input:  news_GOOGL.csv  (columns: Date, Article_title, Lsa_summary, Stock_symbol)
Output: news_googl_sentiments_S1_title_only.csv
        news_googl_sentiments_S2_smart_weighted.csv
...
INPUT_FILE = os.path.join(SCRIPT_DIR, "news_GOOGL.csv")
OUTPUT_FILE_BASE = os.path.join(SCRIPT_DIR, "news_googl_sentiments")
BATCH_SIZE = 32
...
print("=" * 70)
print("SENTIMENT ANALYSIS - NEWS GOOGL (2 STRATEGIES)")
print("=" * 70)
print(f"\nInput:  {INPUT_FILE}")
