...
header-includes:
  ...
  - \usepackage{pdfpages}
  - \newcommand{\real}[1]{#1}
  - \renewcommand{\refname}{7. Referencias}
  - \renewcommand{\contentsname}{Índice}
  - \renewcommand{\bibsection}{\phantomsection\addcontentsline{toc}{section}{\refname}\section*{\refname}}
---
...
El código de extracción, procesamiento y análisis, junto con los datos intermedios necesarios para reproducir los resultados de este trabajo, está disponible públicamente en el repositorio del proyecto en GitHub.^[Disponible en <https://github.com/YelkoB/TFM-sentiment-stocks>.]
